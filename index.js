...
console.log(createMenuItem("cheesesteak", 6, "lunch"));
...
reviews.push({ name: "Kenny", rating: 5, feedback: "Amazing food selection!" });
console.log(reviews);
...
function getReviewByRating(array, filteredRating) {
  ...
  for (let i = 0; i < array.length; i++) {
    if (
      array[i].rating >= filteredRating &&
      array[i].rating < filteredRating + 1
    ) {
